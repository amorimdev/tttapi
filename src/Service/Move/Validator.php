...
namespace TicTacToe\Service\Move;

use TicTacToe\Exception\InvalidBoardException;
use TicTacToe\Exception\InvalidPlayerUnitException;

/**
 * Class Validator
 * @package TicTacToe\Service\Move
 */
class Validator
{
    /**
